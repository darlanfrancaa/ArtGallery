...
public class ObraServiceImpl implements ObraService {
    ...
    public ObraServiceImpl(IRepositorioObra obraRepository, ExposicaoService exposicaoService) {
    ...
    public Vector<Obra> obrasExpostas(String nomeExposicao) throws NotaInvalidaException, ExposicaoNaoEncontradaException, ObraInativaException {
        Exposicao exposicao = exposicaoService.getExpByNome(nomeExposicao);
